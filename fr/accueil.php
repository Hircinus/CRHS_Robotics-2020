<?php
$title = "CRHS Robotique 2020 - ESPN Accueil";
...
<div id="homerow" class="row justify-content-center align-items-center">
	<div class="col-lg-7 col-md-12 col-sm-12 col-12">
      ...
      <hr>
      <h2>&Eacute;dition 2020</h2>
	</div>
	<div class="col-lg-5 col-md-12 col-sm-12 col-12">
      <a class="btnlink" href="about">Qui sommes-nous?</a>
      <a class="btnlink" href="team">Notre &eacute;quipe</a>
	</div>
</div>
<div id="row" class="row justify-content-center">
   <div id="side-card" class="col-lg-3 col-md-0 col-sm-0 col-0">
      <h3>Quelques lonks</h3>
      <ul class="no_bullet">
         <li><a class="link" href="#">Premi&egrave;re rencontre: c'est quoi le plan de jeu?</a></li>
	...
	<div id="article" class="col-lg-6 col-md-9 col-sm-12 col-12">
		<div class="card">
		  ...
		  <div class="card-body tech-article">
			...
			<h5 class="card-title">Une article</h5>
			<p class="card-text">Cool text to make you wanna learn more about something.</p>
			<a href="article/01" class="link">Continuer la lecture</a>
		  </div>
		</div>
	</div>
	...
	<div id="article" class="col-lg-6 col-md-9 col-sm-12 col-12">
		<div class="card">
		  ...
		  <div class="card-body important-article">
			...
			<p class="card-text">Cool text to make you wanna learn more about something.</p>
			<a href="article/12" class="link">Continuer la lecture</a>
		  </div>
		</div>
	</div>
</div>
	...
	<div id="article" class="col-lg-6 col-md-9 col-sm-12 col-12">
		<div class="card">
		  ...
		  <div class="card-body important-article">
			...
			<h5 class="card-title">An article</h5>
			<p class="card-text">Cool text to make you wanna learn more about something.</p>
			<a href="article/11" class="link">Continuer la lecture</a>
		  </div>
		</div>
	</div>
</div>
