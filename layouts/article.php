	...
	<div class="container">
		<div id="firstrow" class="row bg-light-j">
			<div class="col-12">
				...
				<h3 class="article-tag"><a href="../articles?category=<?php echo strtolower($tag) ?>" class="<?php
				if($tag == 'Tech') { echo 'orange'; }
				elseif($tag == 'robot') { echo 'black'; }
				elseif($tag == 'Tech') { echo 'blue'; }
				elseif($tag == 'Important') { echo 'green'; }
				elseif($tag == 'kiosk') { echo 'red'; }
				else { echo ''; } ?>"><?php echo $tag ?></a></h3>
				<a class="link" href="../member/<?php echo strtolower($author) ?>"><?php echo $author ?></a>
